...
from .climate_budget_implementation import CarbonAwareTokenBudget
...
if __name__ == "__main__":
    ...
    for error in test_errors:
        ...
        print(f"Original: {type(error).__name__} -> Converted: {type(converted).__name__}")
